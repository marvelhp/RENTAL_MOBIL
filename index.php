		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<font size="18"><b><?php echo $this->m_rental->get_data('customer')->num_rows(); ?></b></font>
						</div>
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<font size="18"><b><?php echo $this->m_rental->edit_data(array('status_peminjaman'=>0),'transaksi')->num_rows(); ?></b></font>
						</div>
		...
		<div class="panel panel-danger">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<font size="18"><b><?php echo $this->m_rental->edit_data(array('status_peminjaman'=>1),'transaksi')->num_rows(); ?></b></font>
						</div>
	...
	<div class="row">
		<div class="col-lg-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title" style="font-size: 18px; font-weight: bold;"><i class="glyphicon glyphicon-random arrow-right"></i> Mobil</h3>
				</div>
				<div class="panel-body">
					<div class="list-group">
						<?php foreach($mobil as $b){ ?>
							<a href="#" class="list-group-item">
								<span class="badge"><?php if($b->status_mobil == 1){echo "Tersedia";}else{echo "Dipinjam";}?></span>
								<i class="glyphicon glyphiconuser"></i> <?php echo $b->nama_mobil; ?>
							</a>
						<?php } ?>
					</div>
		...
		<div class="col-lg-3">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title" style="font-size: 18px; font-weight: bold;"><i class="glyphicon glyphicon-user o"></i> Customer Terbaru</h3>
				</div>
				<div class="panel-body">
					<div class="list-group">
						<?php foreach($customer as $a){ ?>
							<a href="#" class="list-group-item">
								...
								<i class="glyphicon glyphiconuser"></i> <?php echo $a->nama_customer; ?>
							</a>
							<?php } ?>
					</div>
					<div class="text-right">
